...
<!--    <rect fill="none" height="50" width="50"/>-->
    <path
        ...
        stroke-width="2"/>
    <polyline points="20,28 25,23 30,28" :stroke="color" stroke-linecap="round" stroke-miterlimit="10"
              stroke-width="2"/>
    <line fill="none" :stroke="color" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" x1="25" x2="25"
          y1="43" y2="23.333"/>
  </svg>
</template>
